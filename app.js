...
const RECETTES = {
  hiver: [
    ...
    { nom:'Bœuf mijoté curcuma-tomates', emoji:'🍖', pourquoi:'Le bœuf est la meilleure source de fer héminique (biodisponibilité 25%). Le curcuma réduit les prostaglandines responsables des crampes selon les études récentes en nutrition cyclique.', ingredients:['200g bœuf en morceaux (paleron)','1 boîte tomates pelées','100g petits pois surgelés','1 cc curcuma, 1 cc cumin, 1 oignon','Huile d\'olive, sel, poivre'], etapes:['Faire dorer le bœuf sur toutes les faces','Ajouter l\'oignon émincé et les épices','Verser les tomates pelées écrasées','Couvrir et mijoter 45 min à feu doux','Ajouter les petits pois les 5 dernières min'] },
  ...
  ete: [
    ...
    { nom:'Gaspacho tomates-poivron-concombre', emoji:'🍅', pourquoi:'Hydratant et riche en lycopène antioxydant. Parfait à l\'ovulation pour soutenir les cellules ovariennes sans alourdir le corps.', ingredients:['4 tomates bien mûres','1 poivron rouge','½ concombre','1 gousse d\'ail, 1 cs vinaigre de Xérès','Huile d\'olive, sel, basilic'], etapes:['Couper tous les légumes grossièrement','Mixer avec l\'ail et le vinaigre','Ajouter l\'huile d\'olive en filet','Saler, mixer à nouveau finement','Réfrigérer 1h, servir très frais avec basilic'] },
  ...
  automne: [
    ...
    { nom:'Saumon au four-patate douce-épinards', emoji:'🐠', pourquoi:'Le saumon est la meilleure source d\'oméga-3 EPA/DHA qui réduisent l\'inflammation du SPM. La patate douce apporte la vitamine B6 qui régule directement le taux de progestérone en phase lutéale.', ingredients:['150g pavé de saumon','1 petite patate douce en rondelles','Grosse poignée d\'épinards frais','Jus de citron, 1 cs huile d\'olive, aneth','Sel, poivre, paprika fumé'], etapes:['Préchauffer le four à 180°C','Rôtir les rondelles de patate douce 15 min','Placer le saumon sur les patates, assaisonner','Cuire encore 12 min','Servir sur un lit d\'épinards frais + citron'] },
